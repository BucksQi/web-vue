    ...
    <div class="m-footer">
      <ul>
        <li v-for="(item, index) in footerList" :key="index">
          <router-link tag="a" class="cen" :to="{path: item.path, query: {id: item.id}}">{{item.name}}</router-link>
        </li>
        <li>
          <a class="s-fu">
            <p><img :src="collect_src"></p>
            <p>客服</p>
          </a>
        </li>
      </ul>
...
export default {
  ...
  data () {
    return {
      isActiveIndex: 0,
      logo_src: 'http://b2b2c.iskyshop.com/upload/store_logo/152df201-cfc8-47ba-94a3-4efb781b64a5.png',
      menu_src: 'http://b2b2c.iskyshop.com/resources/style/system/front/default/images/weixin/shop_more.png',
      collect_src: 'http://b2b2c.iskyshop.com/resources/style/system/front/default/images/weixin/store_service.png',
      navList: [
        {
          id: 1,
